...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => {
    router.navigate({ to: "/", replace: true }).then(() => {
      router.invalidate();
      reset();
    }).catch(() => window.location.replace("/"));
  }, [reset, router]);

  return <div className="min-h-screen bg-background" aria-label="Returning to FastCredit" />;
}
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "FastCredit" },
      ...
      { property: "og:title", content: "Fastcreditglobal" },
      { property: "og:description", content: "FastCredit Global is a financial dashboard app for managing multiple currencies." },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/bf59bda3-0cb0-4461-9905-f5868a8395f5" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/bf59bda3-0cb0-4461-9905-f5868a8395f5" },
    ],
    links: [
      {
        rel: "stylesheet",
